...
public class OrdenarCursos extends JDialog {
    ...
    public OrdenarCursos(JTable dbTable, DefaultTableModel dftm, String pvQuery) {
        ...
        for (String t : ModelCursos.campos) {
            filas.addElement(t);
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch(c) {
                    ...
                    case "Codigo Programa Curso":
                        c = "codProgramaCurso";
                        break;
                    case "Fecha Inicio Curso":
                        c = "fechaInicioCurso";
                        break;
                    case "Fecha Fin Curso":
                        c = "fechaFinCurso";
                        break;
                }
